...
if (!defined('__TM_HANDLER__'))
	define('__TM_HANDLER__', 1);
...
class tm_handler {
	function parse($data, $query) {
		...
		elseif ( !strcmp(substr($data['rawdata'][1], -15), 'Domain reserved') )
		{
			// Reserved
			$r['regrinfo']['registered'] = 'yes';
		}
		...
		*/
		...
		$r['regyinfo']['referrer'] = 'http://nic.tm';
		$r['regyinfo']['registrar'] = 'NIC.TM';
